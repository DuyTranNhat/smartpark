...
export class CustomersController {
  ...
  create(
    ...
    checkRowLevelPermission(user, (createCustomerDto as any).uid)
    return this.prisma.customer.create({ data: createCustomerDto as any })
  }
  ...
  async update(
    ...
    checkRowLevelPermission(user, (customer as any)?.uid)

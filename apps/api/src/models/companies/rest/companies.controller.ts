...
export class CompaniesController {
  ...
  create(@Body() createCompanyDto: CreateCompany, @GetUser() user: GetUserType) {
    checkRowLevelPermission(user, (createCompanyDto as any).uid)
    return this.prisma.company.create({ data: createCompanyDto as any })
  }
  ...
  async update(
    ...
    checkRowLevelPermission(user, (company as any)?.uid)

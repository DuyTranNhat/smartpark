...
export class SlotsController {
  ...
  create(@Body() createSlotDto: CreateSlot, @GetUser() user: GetUserType) {
    checkRowLevelPermission(user, (createSlotDto as any).uid)
    return this.prisma.slot.create({ data: createSlotDto as any })
  }
  ...
  async update(
    ...
    checkRowLevelPermission(user, (slot as any)?.uid)
    return this.prisma.slot.update({
      where: { id },
      data: updateSlotDto as any,
    })
  }

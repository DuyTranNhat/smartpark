...
export class ReviewsController {
  ...
  create(@Body() createReviewDto: CreateReview, @GetUser() user: GetUserType) {
    checkRowLevelPermission(user, (createReviewDto as any).uid)
    return this.prisma.review.create({ data: createReviewDto as any })
  }
  ...
  async update(
    ...
    checkRowLevelPermission(user, (review as any)?.uid)
    return this.prisma.review.update({
      where: { id },
      data: updateReviewDto as any,
    })
  }

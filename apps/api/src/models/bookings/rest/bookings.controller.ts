...
export class BookingsController {
  ...
  create(
    ...
    checkRowLevelPermission(user, (createBookingDto as any).uid)
    return this.prisma.booking.create({ data: createBookingDto as any })
  }
  ...
  async update(
    ...
    checkRowLevelPermission(user, (booking as any)?.uid)

import { LocationInfo, ViewState } from '@smartpark/util/types'
import { useMap } from 'react-map-gl'
import { Autocomplete } from '../../atoms/Autocomplete'
import { useSearchLocation } from '@smartpark/util/hooks/location'
import { majorCitiesLocationInfo } from '@smartpark/util/constants'

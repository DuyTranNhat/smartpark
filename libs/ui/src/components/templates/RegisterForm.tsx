'use client'
import { Role } from '@smartpark/util/types'
import { useFormRegister } from '@smartpark/forms/src/register'
import { useMutation } from '@apollo/client'
import { RegisterWithCredentialsDocument } from '@smartpark/network/src/gql/generated'
  ...
  return (
    ...
    >
      ...
      <div className="mt-4 text-sm ">
        Already have an smartpark account?
        <br />
